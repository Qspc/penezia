    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="j1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#ff3c00" /><stop offset="1" stopColor="#ff7c40" />
        </linearGradient>
      </defs>
      <path d="M55 18 L28 48 L8 43 L16 85 L38 80 L38 162 L122 162 L122 80 L144 85 L152 43 L132 48 L105 18C98 28 82 34 80 34C78 34 62 28 55 18Z" fill="url(#j1)" opacity="0.9"/>
      <path d="M55 18C60 38 75 44 80 44C85 44 100 38 105 18" fill="none" stroke="white" strokeWidth="1.5" opacity="0.5"/>
      ...
      <text x="80" y="131" textAnchor="middle" fill="white" fontSize="18" fontFamily="Bebas Neue, sans-serif" fontWeight="bold">10</text>
    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="k1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1e3a8a" /><stop offset="1" stopColor="#3b82f6" />
        </linearGradient>
      </defs>
      <path d="M52 15 L25 45 L5 40 L14 82 L36 77 L36 165 L124 165 L124 77 L146 82 L155 40 L135 45 L108 15C102 25 88 30 80 30C72 30 58 25 52 15Z" fill="url(#k1)" opacity="0.9"/>
      ...
      <rect x="52" y="15" width="28" height="22" rx="3" fill="rgba(255,255,255,0.1)" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/>
      <rect x="80" y="15" width="28" height="22" rx="3" fill="rgba(255,255,255,0.1)" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/>
      <rect x="50" y="80" width="24" height="16" rx="3" fill="rgba(255,255,255,0.15)" stroke="rgba(255,255,255,0.2)" strokeWidth="1"/>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="p1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#064e3b" /><stop offset="1" stopColor="#10b981" />
        </linearGradient>
      </defs>
      <path d="M50 20 L20 50 L5 45 L12 84 L35 78 L35 165 L125 165 L125 78 L148 84 L155 45 L140 50 L110 20C103 30 90 36 80 36C70 36 57 30 50 20Z" fill="url(#p1)" opacity="0.9"/>
      <path d="M65 20 C68 35 76 40 80 40 C84 40 92 35 95 20" fill="none" stroke="white" strokeWidth="1.5" opacity="0.4"/>
    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="ja1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1c1917" /><stop offset="1" stopColor="#44403c" />
        </linearGradient>
      </defs>
      <path d="M45 18 L15 55 L5 50 L10 90 L35 84 L35 168 L125 168 L125 84 L150 90 L155 50 L145 55 L115 18 L100 30 L80 35 L60 30Z" fill="url(#ja1)" opacity="0.95"/>
      <path d="M80 35 L80 168" stroke="#ff3c00" strokeWidth="2" opacity="0.7"/>
      <rect x="50" y="22" width="30" height="18" rx="3" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
      <rect x="80" y="22" width="30" height="18" rx="3" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.15)" strokeWidth="1"/>
      <rect x="38" y="85" width="22" height="14" rx="3" fill="rgba(255,60,0,0.3)" stroke="rgba(255,60,0,0.5)" strokeWidth="1"/>
      <path d="M80 35 L80 40 M80 40 C80 40 60 38 55 42 M80 40 C80 40 100 38 105 42" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="r1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4c1d95" /><stop offset="1" stopColor="#7c3aed" />
        </linearGradient>
      </defs>
      <path d="M50 20 L30 50 L30 168 L130 168 L130 50 L110 20 L95 32 L80 36 L65 32Z" fill="url(#r1)" opacity="0.9"/>
      <path d="M80 36 L80 168" stroke="rgba(245,197,66,0.6)" strokeWidth="2"/>
      <path d="M50 20 C50 20 55 15 80 12 C105 15 110 20 110 20" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/>
      <rect x="40" y="80" width="28" height="18" rx="4" fill="rgba(245,197,66,0.2)" stroke="rgba(245,197,66,0.4)" strokeWidth="1"/>
      <rect x="92" y="80" width="28" height="18" rx="4" fill="rgba(245,197,66,0.2)" stroke="rgba(245,197,66,0.4)" strokeWidth="1"/>
      <rect x="62" y="120" width="36" height="22" rx="4" fill="rgba(0,0,0,0.3)" stroke="rgba(255,255,255,0.1)" strokeWidth="1"/>
    </svg>
  );
}
    ...
    <svg viewBox="0 0 160 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="ka1" x1="0" y1="0" x2="160" y2="180" gradientUnits="userSpaceOnUse">
          <stop stopColor="#881337" /><stop offset="1" stopColor="#f43f5e" />
        </linearGradient>
      </defs>
      <path d="M55 18 L28 48 L8 43 L16 85 L38 80 L38 162 L122 162 L122 80 L144 85 L152 43 L132 48 L105 18C98 28 82 34 80 34C78 34 62 28 55 18Z" fill="url(#ka1)" opacity="0.9"/>
      <path d="M55 18C60 38 75 44 80 44C85 44 100 38 105 18" fill="none" stroke="white" strokeWidth="1.5" opacity="0.4"/>
      <text x="80" y="120" textAnchor="middle" fill="white" fontSize="32" fontFamily="Bebas Neue, sans-serif" opacity="0.4">PC</text>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {products.map((product, i) => {
            ...
            const waMsg = encodeURIComponent(`Halo PrintCraft! Saya ingin pesan ${product.name} custom. Bisa minta info lebih lanjut?`);
            return (
              <motion.div
                key={i}
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: `${product.tagColor}25`, color: product.tagColor, border: `1px solid ${product.tagColor}50` }}
                >
                  {product.tag}
                </div>
                ...
                <div className="relative flex items-center justify-center h-52 p-6 overflow-hidden">
                  <div className="absolute inset-0 opacity-10"
                    style={{ background: `radial-gradient(circle at 50% 60%, ${product.tagColor}, transparent 70%)` }} />
        ...
        >
          ...
          <p className="text-[#8888a0] mb-6 relative z-10">
            Seragam satpam, baju kuliah, merchandise event, topi custom, dan masih banyak lagi — konsultasikan kebutuhan Anda!
          </p>
          <a
            href="https://wa.me/6281234567890?text=Halo%20PrintCraft%2C%20saya%20ingin%20konsultasi%20kebutuhan%20seragam%20custom"
            target="_blank"
            rel="noopener noreferrer"
